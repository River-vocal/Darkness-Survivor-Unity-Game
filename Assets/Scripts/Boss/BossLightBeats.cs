...
public class BossLightBeats : AudioEffector
{
    public Light2D spotLight;
    [FormerlySerializedAs("player")] public Boss boss;
    ...
    public override void Update()
    {
        ...
        boss.attackDamage = Math.Max((int)Math.Round(volumeIntensity), minDamage) ;
    }
