...
public class AudioEffectorLights2DColor3 : AudioEffector
{
    ...
    public override void Update()
    {
        ...
        light2D.intensity = Math.Min(0.23f, lightIntensity);
        light2D.color = new Color(0.3f + effectorValue * 5f, 0.36f + effectorValue * 5f, 1, 0.2f + effectorValue * 3f);
    }
}